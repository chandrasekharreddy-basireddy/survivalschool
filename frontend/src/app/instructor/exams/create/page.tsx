...
function CreateExamForm() {
  ...
  if (!courseId) {
    return (
      <div className="mx-auto max-w-md px-6 py-24 text-center">
        <p className="text-slate-300">Open this page from a course&apos;s manage screen so it knows which course to attach the exam to.</p>
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      <h1 className="text-2xl font-bold text-white">Create an exam</h1>
