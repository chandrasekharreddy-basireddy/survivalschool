  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <h2 className="text-2xl font-bold text-fg sm:text-3xl">Everything a modern EdTech platform needs</h2>
        <p className="mt-2 max-w-xl text-fg-muted">No filler dashboards. No fake stats. Every number on this platform is computed by the backend.</p>
      ...
      <section className="border-y border-ink-800 bg-ink-900/40">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <h2 className="text-2xl font-bold text-fg sm:text-3xl">How it works</h2>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="card flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          <div>
            <h2 className="text-xl font-bold text-fg">Have a certificate to check?</h2>
            <p className="mt-1 text-sm text-fg-muted">Verify any Survival School certificate publicly — no account needed.</p>
          </div>
          <Link href="/certificates/verify" className="btn-secondary">Verify a certificate</Link>
        </div>
      </section>

      <footer className="border-t border-ink-800 py-10 text-center text-sm text-fg-subtle">
