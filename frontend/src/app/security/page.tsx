...
const PRACTICES = [
  ...
  { title: "Role-based access", desc: "Every action — grading, publishing a question, assigning a role — is checked against the caller's role on the server, not just hidden in the UI." },
